...
class JsonStore:
    ...
    collections = {
        ...
        "runs": DemoRun,
        "events": RunEvent,
        "managed_chat_resources": ManagedChatResources,
        "managed_chat_deployments": ManagedChatDeployment,
        "managed_chat_sessions": ManagedChatSession,
        "managed_chat_events": ManagedChatEvent,
        "managed_agent_research_resources": ManagedAgentResearchResources,
